...
API REST en ASP.NET Core 6 avec un front en HTML/CSS/JS vanilla, connectée à une base de données SQL Server LocalDB.
...
Entity Framework Core 6 (Code First, migrations)
...
HTML / CSS / JS vanilla (servi via wwwroot)

Fetch API, localStorage, décodage JWT avec atob()
